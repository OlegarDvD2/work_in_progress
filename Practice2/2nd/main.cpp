...
int main() 
{
    ...
    float r, x, y;
    cout << "r, x, y   Первого Круга: "#include "iostream"
#include "circle.h"
...
int main() 
{
    ...
    if (circle1.triangle_around(2, 5, 6) == 1)
    {
        cout << "Можно ли описать вокруг треугольника: Yes" << endl;
    }
    else
    {
        cout << "Можно ли описать вокруг треугольника: No" << endl;
    }
    if (circle1.triangle_in(2, 5, 6) == 1)
    {
        cout << "Можно ли вписать треугольник: Yes" << endl;
    }
    else
    {
        cout << "Можно ли вписать треугольник: No" << endl;
    }
